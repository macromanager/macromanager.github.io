...
function () {
  ...
  DownloadsComponent.prototype.installerClickHandler = function (event) {
    ...
    this.productInfoService.DownLoadInstaller(version); // .then(installers => {
...
var IocRegistrations_1 = __webpack_require__(513);
...
var Customer_1 = __webpack_require__(526);
...
var axios_1 = __webpack_require__(529);
...
var MainModuleLibrary_1 = __webpack_require__(566); // var service = Bootstrapper.getInstanceByType(ProductInfoService);
...
var ModuleLoader_1 = __webpack_require__(514);
...
function () {
  ...
  IocRegistrations.loadServices = function (container) {
    var ctx = __webpack_require__(565);
...
var forms_1 = __webpack_require__(567);

var router_1 = __webpack_require__(265);

var ApplicationRoutes_1 = __webpack_require__(568);
...
function initializeApp(injector) {
  return function () {
    return Bootstrapper_1.Bootstrapper.loadAsyncServices(injector).then(function () {
...
var AppConfig_1 = __webpack_require__(528);

var GateKeeperClient_1 = __webpack_require__(253);

var Card_1 = __webpack_require__(250);

var Installer_1 = __webpack_require__(546);
